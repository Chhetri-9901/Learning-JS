...
const invertors1500 = inventors.filter((inventor) => {
    return inventor.year >= 1500 && inventor.year < 1600;
})
console.log("Inventors born in 1500 are: ");
...
console.log("Inventors full names are as follows: ");
...
const inventorsTotalYear = inventors.reduce((accumulator, current) => {
    return (accumulator ) + (current.passed - current.year);
}, 0);
console.log("Inventors total years: ");
console.log(inventorsTotalYear);